...
import ReactionChannel, {
  server_id,
} from "../../../channels/reactions_channel";
      ...
      <div className="player-complete">
        ...
        <div className="action-wrapper">
          <div className="content_reactionbuttonline">
            <Button onClick={() => handleReaction(HEART_REACTION)}>
              <Counter id="heartCounter" className="counter-box">
                {reaction.heartCounter}
                <i className="fas fa-heart"></i>
              </Counter>
            </Button>
            <Button onClick={() => handleReaction(FIRE_REACTION)}>
              <Counter id="fireCounter" className="counter-box">
                {reaction.fireCounter} <i className="fas fa-fire-alt"></i>
              </Counter>
            </Button>
            <Button onClick={() => handleReaction(LIKE_REACTION)}>
              <Counter id="likeCounter" className="counter-box">
                {reaction.likeCounter} <i className="fas fa-thumbs-up"></i>
              </Counter>
            </Button>
            <Button onClick={() => handleReaction(DISLIKE_REACTION)}>
              <Counter id="dislikeCounter" className="counter-box">
                {reaction.dislikeCounter} <i className="fas fa-thumbs-down"></i>
              </Counter>
            </Button>
          </div>
        </div>
