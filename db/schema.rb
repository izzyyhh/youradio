...
ActiveRecord::Schema.define(version: 2021_05_05_133147) do
  ...
  create_table "active_userlists", force: :cascade do |t|
    ...
    t.boolean "is_active"
    t.index ["server_id"], name: "index_active_userlists_on_server_id"
    t.index ["user_id"], name: "index_active_userlists_on_user_id"
  end
  ...
  add_foreign_key "active_userlists", "servers"
  add_foreign_key "active_userlists", "users"
  add_foreign_key "chatmessages", "servers"
  add_foreign_key "playlists", "servers"
